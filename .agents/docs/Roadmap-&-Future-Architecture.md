...
This page outlines the strategic technical evolution of Nuilith. The current architecture relies on a decoupled three-layer model—Main Thread (`index.js`), Web Worker (`worker.js`), and Service Worker (`sw.js`) [README.md42-49](https://github.com/NarmakTwo/nuilith/blob/9fa46400/README.md?plain=1#L42-L49) To transition from a browser-based editor to a comprehensive IDE, several structural migrations and feature integrations are planned.

## Core Editor Migration: Monaco Editor

The current implementation uses **CodeMirror v5** to handle text editing, linting annotations, and keybindings [README.md46](https://github.com/NarmakTwo/nuilith/blob/9fa46400/README.md?plain=1#L46-L46) While lightweight, it lacks the advanced Language Server Protocol (LSP) support and performance of modern IDEs.
...
**Sources:**[README.md42-49](https://github.com/NarmakTwo/nuilith/blob/9fa46400/README.md?plain=1#L42-L49)[CONTRIBUTING.md66](https://github.com/NarmakTwo/nuilith/blob/9fa46400/CONTRIBUTING.md?plain=1#L66-L66)
...
- **Persistence**: The `.nu` format (JSZip) will be updated to include a `.ipynb` compatible JSON structure within the `manifest.json` or as separate files [README.md75](https://github.com/NarmakTwo/nuilith/blob/9fa46400/README.md?plain=1#L75-L75)

### Matplotlib Integration

Currently, `stdout` and `stderr` are piped to `jQuery Terminal`[README.md47](https://github.com/NarmakTwo/nuilith/blob/9fa46400/README.md?plain=1#L47-L47) Matplotlib requires a virtual canvas.
...
**Sources:**[README.md42-49](https://github.com/NarmakTwo/nuilith/blob/9fa46400/README.md?plain=1#L42-L49)[README.md102-103](https://github.com/NarmakTwo/nuilith/blob/9fa46400/README.md?plain=1#L102-L103)[CONTRIBUTING.md60-61](https://github.com/NarmakTwo/nuilith/blob/9fa46400/CONTRIBUTING.md?plain=1#L60-L61)
...
- **Unified I/O**: The synchronous `input()` intercept logic using `/get_input` and `sw.js` will be abstracted to serve any language requiring blocking I/O [README.md54-61](https://github.com/NarmakTwo/nuilith/blob/9fa46400/README.md?plain=1#L54-L61)

**Sources:**[README.md105](https://github.com/NarmakTwo/nuilith/blob/9fa46400/README.md?plain=1#L105-L105)[CONTRIBUTING.md63](https://github.com/NarmakTwo/nuilith/blob/9fa46400/CONTRIBUTING.md?plain=1#L63-L63)

---

## UI Modernization: Modular Sidebar & Persistence

The current UI is a dual-pane flexbox layout [README.md46](https://github.com/NarmakTwo/nuilith/blob/9fa46400/README.md?plain=1#L46-L46) Future iterations will introduce a more extensible workspace.

### Enhanced Sidebar

A new sidebar component will manage:

1. **File Explorer**: Direct manipulation of the virtual filesystem stored in `IndexedDB`[README.md71](https://github.com/NarmakTwo/nuilith/blob/9fa46400/README.md?plain=1#L71-L71)
2. **Extension Marketplace**: A system to toggle features like the `micropip` manager or theme settings [README.md73](https://github.com/NarmakTwo/nuilith/blob/9fa46400/README.md?plain=1#L73-L73)

### Backend & Cloud Persistence

While Nuilith is currently "static-first" and relies on `IndexedDB` for auto-save [README.md74](https://github.com/NarmakTwo/nuilith/blob/9fa46400/README.md?plain=1#L74-L74) a backend layer is planned for:
...
**Sources:**[README.md71-74](https://github.com/NarmakTwo/nuilith/blob/9fa46400/README.md?plain=1#L71-L74)[README.md104-107](https://github.com/NarmakTwo/nuilith/blob/9fa46400/README.md?plain=1#L104-L107)[CONTRIBUTING.md62-65](https://github.com/NarmakTwo/nuilith/blob/9fa46400/CONTRIBUTING.md?plain=1#L62-L65)
...
**Sources:**[README.md98-107](https://github.com/NarmakTwo/nuilith/blob/9fa46400/README.md?plain=1#L98-L107)[CONTRIBUTING.md58-67](https://github.com/NarmakTwo/nuilith/blob/9fa46400/CONTRIBUTING.md?plain=1#L58-L67)
